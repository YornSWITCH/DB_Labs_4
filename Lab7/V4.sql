...
/* Вывести значения полей [BusinessEntityID], [Name], [AccountNumber] из таблицы [Purchasing].[Vendor] в виде xml, сохраненного в переменную. */
...
IF OBJECT_ID('[dbo].GetVendorTableFromXML', 'P') IS NOT NULL
    DROP PROCEDURE GetVendorTableFromXML;
GO
